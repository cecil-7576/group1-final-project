...
const displayedCart = isHome ? cart.slice(0, 3) : cart;
  ...
  return (
    <section className="bg-[#fff5e9] min-h-screen px-4 md:px-16 pt-28 pb-20">
        ...
        <div className="mt-4 text-center">
          ...
          className="w-full bg-[#fb6605] text-white px-12 py-3 rounded hover:bg-orange-600 transition font-semibold">Checkout</button>
          <p className="text-sm text-gray-600 mt-1">Taxes and shipping are calculated at checkout</p>
        </div>
    </section>
  )
}
